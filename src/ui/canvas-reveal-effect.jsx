  ...
  return (
    ...
    >
      <div className="flex w-full h-full">
        <div className="w-1/5 h-full border-l-2 border-t-2 border-b-2 border-white "></div>
        <div className="w-3/5 h-full 0"></div>
        <div className="w-1/5 h-full border-r-2 border-t-2 border-b-2 border-white"></div>
      </div>
    </div>
  );
};