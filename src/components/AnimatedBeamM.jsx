...
import Zlogo from '../assets/zicon.jpeg'
...
export function AnimatedBeamMultipleOutputDemo({className}) {
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] w-full items-center justify-center overflow-hidden p-10 max-w-5xl mx-auto bg-gray-100 border border-gray-200 rounded-2xl shadow-lg shadow-orange-300",
        className,
      )}
      ref={containerRef}
    >
  ...
  <div
    ref={div6Ref}
    className="size-16 flex items-center justify-center rounded-xl border-2 border-orange-500 z-10 bg-white p-2 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]"
  >
    <img src={Zlogo} alt="Z Logo" className="h-10 w-10 object-contain" />
  </div>
</div>
